...
namespace Otel
{
    public partial class Yenirez : UserControl
    {
        public Yenirez()
        {
            InitializeComponent();
        ...
        private void Yenirez_VisibleChanged(object sender, EventArgs e)
        {
            ...
            komut222.CommandText = "select distinct o.Kat_No as ' Kat' , o.Oda_No as 'Oda No',o.Oda_Turu as ' Oda Türü' from Odalar as o  left join Hesap as h on o.Oda_No=h.Oda_No   where   (h.Giris_Tarihi IS NULL) or not((h.Giris_Tarihi < '" + kTarih.ToString("MM/dd/yyyy HH:mm:ss") + "' and h.Cikis_Tarihi > '" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "')) and not(o.Oda_No = any(select distinct o.Oda_No  from Odalar as o  left join Hesap as h on o.Oda_No=h.Oda_No   where   ((h.Giris_Tarihi < '" + kTarih.ToString("MM/dd/yyyy HH:mm:ss") + "' and h.Cikis_Tarihi > '" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "')))) order by o.Oda_No ";
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!(comboBox2.SelectedIndex == 0))
            {
                ...
                {
                    komut.CommandText = "select distinct o.Kat_No as ' Kat' , o.Oda_No as 'Oda No',o.Oda_Turu as ' Oda Türü' from Odalar as o  left join Hesap as h on o.Oda_No=h.Oda_No   where ((o.Kat_No = '" + genel2.secim2 + "') and  ((h.Giris_Tarihi IS NULL) or not((h.Giris_Tarihi < '" + kTarih.ToString("MM/dd/yyyy HH:mm:ss") + "' and h.Cikis_Tarihi > '" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "')) and not(o.Oda_No = any(select distinct o.Oda_No  from Odalar as o  left join Hesap as h on o.Oda_No=h.Oda_No   where   ((h.Giris_Tarihi < '" + kTarih.ToString("MM/dd/yyyy HH:mm:ss") + "' and h.Cikis_Tarihi > '" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "')))))) order by o.Oda_No ";
                    komut.Connection = yeni;
                    SqlDataReader oku = komut.ExecuteReader();
                    DataTable tablo = new DataTable();
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!(comboBox3.SelectedIndex == 0))
            {
                ...
                {
                    komut.CommandText = "select distinct o.Kat_No as ' Kat' , o.Oda_No as 'Oda No',o.Oda_Turu as ' Oda Türü' from Odalar as o  left join Hesap as h on o.Oda_No=h.Oda_No  where  ((o.Oda_Turu = '" + genel2.secim3 + "') and ((h.Giris_Tarihi IS NULL) or not((h.Giris_Tarihi < '" + kTarih.ToString("MM/dd/yyyy HH:mm:ss") + "' and h.Cikis_Tarihi > '" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "')) and not(o.Oda_No = any(select distinct o.Oda_No  from Odalar as o  left join Hesap as h on o.Oda_No=h.Oda_No   where   ((h.Giris_Tarihi < '" + kTarih.ToString("MM/dd/yyyy HH:mm:ss") + "' and h.Cikis_Tarihi > '" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "')))))) order by o.Oda_No ";
                    komut.Connection = yeni;
                    SqlDataReader oku = komut.ExecuteReader();
                    DataTable tablo = new DataTable();
                    tablo.Load(oku); dataGridView1.DataSource = tablo;
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            listBox1.Items.Clear();
            string sorgu = "Select * from Musteri as m left join Hesap as h on m.Musteri_no=h.Musteri_no where h.Oda_No = '" + yerbil + "' and  h.Giris_Tarihi ='" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "'  ";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    SqlCommand komut6 = new SqlCommand();
                    komut6.CommandText = "select distinct o.Kat_No as ' Kat' , o.Oda_No as 'Oda No',o.Oda_Turu as ' Oda Türü' from Odalar as o  left join Hesap as h on o.Oda_No=h.Oda_No   where   (h.Giris_Tarihi IS NULL) or not((h.Giris_Tarihi < '" + kTarih.ToString("MM/dd/yyyy HH:mm:ss") + "' and h.Cikis_Tarihi > '" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "')) and not(o.Oda_No = any(select distinct o.Oda_No  from Odalar as o  left join Hesap as h on o.Oda_No=h.Oda_No   where   ((h.Giris_Tarihi < '" + kTarih.ToString("MM/dd/yyyy HH:mm:ss") + "' and h.Cikis_Tarihi > '" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "')))) order by o.Oda_No ";
                    komut6.Connection = yeni;
        ...
        private void textBox2_TextChanged(object sender, EventArgs e)
        {
            ...
            yeni.Open();
            SqlCommand komut = new SqlCommand();
            komut.CommandText = "select distinct o.Kat_No as ' Kat' , o.Oda_No as 'Oda No',o.Oda_Turu as ' Oda Türü' from Odalar as o  left join Hesap as h on o.Oda_No=h.Oda_No   where  o.Oda_No Like '" + textBox2.Text + "%' and (h.Giris_Tarihi IS NULL) or not((h.Giris_Tarihi < '" + kTarih.ToString("MM/dd/yyyy HH:mm:ss") + "' and h.Cikis_Tarihi > '" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "')) and not(o.Oda_No = any(select distinct o.Oda_No  from Odalar as o  left join Hesap as h on o.Oda_No=h.Oda_No   where   ((h.Giris_Tarihi < '" + kTarih.ToString("MM/dd/yyyy HH:mm:ss") + "' and h.Cikis_Tarihi > '" + bTarih.ToString("MM/dd/yyyy HH:mm:ss") + "')))) order by o.Oda_No ";
            komut.Connection = yeni;
            SqlDataReader oku = komut.ExecuteReader();
            DataTable tablo = new DataTable();
            tablo.Load(oku); dataGridView1.DataSource = tablo;
        ...
        private void label27_Click(object sender, EventArgs e)
        {
            ...
            Baslangic.Instance.pnlcontainer.Controls["rezarvasyon"].Hide();
            Baslangic.Instance.pnlcontainer.Controls["rezarvasyon"].BringToFront();
